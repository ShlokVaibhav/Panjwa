...
\title{Analytical DOS derivation for Zig-Zag CNTs}
...
\begin{abstract}
In this tutorial, we derive analytically the density of states for a Zig-Zag CNT that matches 
the expression in ~\cite{leonardPropertiesShortChannel2006}. This tutorial is intended for 
students working with Zig-Zag CNTs for the first time and in relatively simpler steps than in 
Mintmire and White (PRL 81, 2506, 1998)
\end{abstract}
